            ...
            <div class="card card-flush ">
              <div class="card-header mt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <router-link to="/admin/project/trash" class="btn btn-light-primary" >
                    ...
                    <router-link to="/admin/project/add" class="btn btn-light-primary ms-3" >
                ...
                <div class="table-responsive">
                    ...
                    <tbody class="fw-semibold text-gray-600 listData">
                        ...
                        <td class="text-end">
                            ...
                            <router-link :to="'/admin/project/show/' + row.id" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3 btnEdit" >
                            ...
                            <router-link :to="'/admin/project/edit/' + row.id" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3 btnEdit" >
  ...
  methods: {
    async loadProjectData(page, limit, keywords) {
        ...
        try {
            ...
            const res = await projectServices.getAll(page, limit, keywords);
    ...
    async doDelete(id){
        ...
        try {
            ...
            const res = await projectServices.delete(formData);
