<template>
            ...
            <div class="card card-flush ">
              <div class="card-header mt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <router-link to="/admin/category/add" class="btn btn-light-primary" >
              ...
              <div class="card-body pt-0">
                <div class="table-responsive">
                    ...
                    <tbody class="fw-semibold text-gray-600 listData">
                        ...
                        <tr v-for="row in categoryData" :key="row.id">
                        <td>
                        ...
                        <td class="text-end">
                            ...
                            <router-link :to="'/admin/category/edit/' + row.id" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3 btnEdit" >
    ...
    <ModalConfirm v-if="modalConfirm" @close="modalConfirm = false" >
        <div class="d-flex flex-column">
            <div class="mb-5">Apakah akan menghapus data <strong>{{ categoryNameDelete }}</strong> ini ? </div>
            <div class="d-flex justify-content-between align-items-center">
                <button class="btn btn-sm btn-primary" @click="doDelete(categoryIdDelete)">Hapus</button>
...
export default {
  ...
  created() {
    ...
    this.limit = 5;
    //this.loadCategoryData(this.page, this.limit, this.keywords);
    const res =  this.loadCategoryData(this.pageCount, this.limit, this.keywords);
    res.then((data) => {
        this.pageTotal = data.pageTotal;
    });
  },
  methods: {
    async loadCategoryData(page, limit, keywords) {

        try {

            const res = await categoryServices.getAll(page, limit, keywords);
    ...
    async doSearch() {
        ...
        const res = await this.loadCategoryData(this.pageCount, this.limit, this.keywords);
    },
    ...
    showDeleteModal(payload) {
        ...
        this.categoryNameDelete = payload.name;
        this.categoryIdDelete = payload.id;
    },
    async doDelete(id){
        ...
        try {
            ...
            const res = await categoryServices.delete(formData);

            if(res.code==200){
                this.toast.success(res.message);
                this.loadCategoryData(this.pageCount, this.limit, this.keywords);
            }else{
